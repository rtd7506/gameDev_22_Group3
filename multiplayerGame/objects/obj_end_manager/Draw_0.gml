...
draw_text_ext(player_center+75,560,"x 5000 = "+string(obj_stat_manager.p_victoryBonus*5000),40,500)
/*
...
draw_text_ext(manager_center+75,560,"x 5000 = "+string(obj_stat_manager.m_victoryBonus*5000),40,500)
/*
